    ...
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        yield return [
            new JsonLexerTestData("""
                ""
            """ ,[
                new Token(TokenType.String, string.Empty),
                new Token(TokenType.EndOfStream, string.Empty),
            ]),
        ];

        yield return [
            new JsonLexerTestData(""" "Hello" """ ,[
        ...
        yield return [
            new JsonLexerTestData(""" "Hello World" """ ,[
        ...
        yield return [
            new JsonLexerTestData(""" "C:\\Users\\John" """, [
        ...
        yield return [
            new JsonLexerTestData("""123.45""", [
                new Token(TokenType.Number, "123.45"),
                new Token(TokenType.EndOfStream, string.Empty),
            ]),
        ];
        ...
        yield return [
            new JsonLexerTestData(""" alpha """, [
                new Token(TokenType.Invalid, "alpha"),
                new Token(TokenType.EndOfStream, string.Empty),
            ]),
        ];

        yield return [
            new JsonLexerTestData(""" beta\ """, [
                new Token(TokenType.Invalid, "beta\\"),
                new Token(TokenType.EndOfStream, string.Empty),
            ]),
        ];

        yield return [
            new JsonLexerTestData(""" gamma123 """, [
                new Token(TokenType.Invalid, "gamma123"),
                new Token(TokenType.EndOfStream, string.Empty),
            ]),
        ];

        yield return [
            new JsonLexerTestData(""" delta12.34 """, [
                new Token(TokenType.Invalid, "delta12.34"),
                new Token(TokenType.EndOfStream, string.Empty),
            ]),
        ];

        yield return [
            new JsonLexerTestData(""" \invalid """, [
        ...
        yield return [
                    ...
                    "Employees": [
                        {
                            "PersonalDetails": { 
                                ...
                                "OtherDetails": {
                                    "Blood Group": "O+",
                                    "Visa Expired": false,
                                    "Emergency Contact Number": PH1234355
                                }
                            }, 
                            "BankDetails": { 
                                "AccountNumber": "100-23435454", 
                        ...
                        },
                        {
                            "PersonalDetails": { 
                                ...
                                "Age": 29,
                                "Citizenship": true,
                                "Contact Number": "+91 124354235",
                                "OtherDetails": {
                                    "Blood Group": "B+",
                                    "Visa Expired": false,
                                    "Emergency Contact Number": "+91 24343"
                                }
                            }, 
                            "BankDetails": { 
                                "AccountNumber": "0123432452454", 
                                "Bank": "Test Bank", 
                                "Active": true
                            } 
                        }
            ...
            """, [
                new Token(TokenType.LeftBrace, "{"),
                new Token(TokenType.String, "Employees"),
                new Token(TokenType.Colon, ":"),
                new Token(TokenType.LeftBracket, "["),
                new Token(TokenType.LeftBrace, "{"),
                new Token(TokenType.String, "PersonalDetails"),
                ...
                new Token(TokenType.String, "Emergency Contact Number"),
                new Token(TokenType.Colon, ":"),
                new Token(TokenType.Invalid, "PH1234355"),
                new Token(TokenType.RightBrace, "}"),
                new Token(TokenType.RightBrace, "}"),
                new Token(TokenType.Comma, ","),
                new Token(TokenType.String, "BankDetails"),
                ...
                new Token(TokenType.String, "Contact Number"),
                new Token(TokenType.Colon, ":"),
                new Token(TokenType.String, "+91 124354235"),
                new Token(TokenType.Comma, ","),
                new Token(TokenType.String, "OtherDetails"),
                new Token(TokenType.Colon, ":"),
                new Token(TokenType.LeftBrace, "{"),
                ...
                new Token(TokenType.String, "Emergency Contact Number"),
                new Token(TokenType.Colon, ":"),
                new Token(TokenType.String, "+91 24343"),
                new Token(TokenType.RightBrace, "}"),
                new Token(TokenType.RightBrace, "}"),
                new Token(TokenType.Comma, ","),
                new Token(TokenType.String, "BankDetails"),
                ...
                new Token(TokenType.String, "AccountNumber"),
                new Token(TokenType.Colon, ":"),
                new Token(TokenType.String, "0123432452454"),
                new Token(TokenType.Comma, ","),
                new Token(TokenType.String, "Bank"),
                new Token(TokenType.Colon, ":"),
                new Token(TokenType.String, "Test Bank"),
                new Token(TokenType.Comma, ","),
                new Token(TokenType.String, "Active"),
                new Token(TokenType.Colon, ":"),
                new Token(TokenType.Identifier, "true"),
